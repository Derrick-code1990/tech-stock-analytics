...
# GCS
GCS_BUCKET_RAW=your-raw-bucket-name
GCS_BUCKET_STAGED=your-staged-bucket-name
```
...
### Bruin Asset Execution Order

```
raw_stock_metadata ──┐
                     ├──▶ stg_stock_metadata ──▶ (marts)
raw_stock_prices ────┘
                         stg_stock_prices   ──▶ mart_daily_ohlcv
                                                      │
                                               bqml_create_models
                                                      │
                                               mart_predictions
